...
var require = {
	app: {
		analytics: true,
		copyright: "2559 by DSP",
		deployType: "development",
		description: "",
		guid: "d6b81862-8371-4573-9555-40daee2612ef",
		id: "com.dsp.pattanimunicipality",
		name: "PattaniMunicipality",
		names: {},
		publisher: "DSP",
		url: "http://",
		version: "1.0"
...
require("Ti/App/Properties", function(p) {
	...
	p.setString("appc-app-id","57a01fae13e4fe223a234915");
	...
	p.setString("acs-oauth-secret-development","P5j1RO1t2mYIqcmR6iPWHV7xTW2oEvhF");
	p.setString("acs-oauth-key-development","tQVvw8guEGTGAQOdQ6ADOQRo4qunNWUj");
	p.setString("acs-api-key-development","0v0eLrHptmrOAyAaEFcO8V0e4HGZisVO");
	p.setString("acs-username-development","appc_app_user_dev");
	p.setString("acs-password-development","jpAAJ0dGVfrJ4inLmB");
	...
	p.setString("acs-oauth-secret-production","Bhkrlj7LiNzG8idIgbNkPQ4mDwpbyVyY");
	p.setString("acs-oauth-key-production","S3ShuONql0xI9pnjh0YKANaG7c9rXoF5");
	p.setString("acs-api-key-production","QcHRRlpcnhotrWqYIiFgAZAwsvl4HZ0V");
	p.setString("acs-username-production","appc_app_user");
	p.setString("acs-password-production","RFd2z0P4FK3tp2OpLH");
	p.setString("appc-org-id","100110489");
	p.setString("appc-creator-user-id","7c7a0e5b-26af-4da2-991a-c510e9fa002d");
});
